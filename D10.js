...
console.log("Il primo numero é il maggiore tra i due:", whoIsBigger(20, 15));
console.log("Il secondo numero é il maggiore tra i due:", whoIsBigger(15, 30));
console.log(whoIsBigger(15, 15));
...
const deleteOne = function deleteOne(str, boolean) {
  if (boolean) {
    return str.slice(1);
  } else {
...
const onlyLetters = function (str) {
  const letters = str.split("").filter(function (char) {
...
console.log(howManyDays("03/06/1998"));
...
const isTodayMyBirthday = function () {
  ...
  const birthday = "03/06";
  const birthdayElements = birthday.split("/");
  const birthdayMonth = parseInt(birthdayElements[0]);
  const birthdayDay = parseInt(birthdayElements[1]);
...
const deleteProp = function (array, str) {
...
const addElementUl = function (str) {
